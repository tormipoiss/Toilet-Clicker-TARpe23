...
namespace Toilet_Clicker.Data.Migrations
{
    ...
    [Migration("20250428115542_initnew")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Toilet_Clicker.Core.Domain.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Toilet_Clicker.Core.Domain.ToiletOwnership", b =>
                {
                    b.HasBaseType("Toilet_Clicker.Core.Domain.Toilet");
                    ...
                    b.HasDiscriminator().HasValue("ToiletOwnership");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Toilet_Clicker.Core.Domain.ApplicationUser", null)
                        .WithMany()
